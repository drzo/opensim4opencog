...
namespace TheOpenSims.Navagation.Mesher
{
    ...
    public static class PrimMesherG
    {
        ...
        // Dmiles added Scale and Rotation
        public static Mesh PrimitiveToIrrMesh(Primitive prim, LevelOfDetail detail, OpenMetaverse.Quaternion rot)
        {
            ...
            newPrim.AddRot(QuaternionToQuat(rot));
            return FacesToIrrMesh(newPrim.viewerFaces, newPrim.numPrimFaces);
        }

        private static Quat QuaternionToQuat(OpenMetaverse.Quaternion quaternion)
        {
        ...
        public static Mesh SculptIrrMesh(System.Drawing.Bitmap bitmap, SculptMesh.SculptType sculptType)
        {
