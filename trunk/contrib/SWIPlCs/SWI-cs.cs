        ...
        public PlTerm this[int pos]
        {
            get
            {
                ...
                if(pos < 0 || pos > this.Arity )
                    throw new ArgumentOutOfRangeException("pos", "Must be greater than 0 and lesser then the arity of the term");
...
#pragma warning restore 1573
	 ...
	 ***************************************/
        ...
        /// <seealso cref="T:SbsSW.SwiPlCs.PlType"/>
        public bool IsList { get { return 0 != libpl.PL_is_list(this.TermRef); } }
	 ...
	 ***************************************/
        ...
        {
            Check.Require(this.IsList || this.IsVar);
