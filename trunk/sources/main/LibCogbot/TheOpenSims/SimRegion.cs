        ...
        public static SimRegion GetRegion(UUID uuid, GridClient client)
        {
            ...
            SimRegion r = null;
            {
                ...
                EventHandler<RegionHandleReplyEventArgs> rrc =
                     (s,e)=>//(delegate(UUID regionID, ulong regionHandle)
                    {
                        if (e.RegionID == uuid)
                        {
                            are.Set();
...
// ReSharper restore PossibleLossOfFraction
        ...
        public static SimRegion GetRegion(string simname, GridClient gc)
        {
            ...
            GridRegion gl;
            if (gc.Grid.GetGridRegion(simname,GridLayerType.Terrain,out gl))
            {
        ...
        {
            get { return (TheSimulator.Flags & RegionFlags.AllowDirectTeleport) != 0; }
        }
