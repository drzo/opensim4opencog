...
{
    internal class BackCommand : Command, BotPersonalCommand
    {
        ...
        {
            Description = "Sends the move back command to the server for a single packet or a given number of seconds.";
            Parameters =
