...
namespace Cogbot.Actions.Land
{
    public class ParcelSelectObjectsCommand : Command, RegionMasterCommand
    {
        ...
        {
            Description =
                "Displays a list of prim localIDs on a given parcel with a specific owner. Usage: selectobjects parcelID OwnerUUID";
        ...
        public override CmdResult ExecuteRequest(CmdRequest args)
        {
                ...
                && UUIDTryParse(args, 1, out ownerUUID, out argsUsed))
            {
                ...
                EventHandler<ForceSelectObjectsReplyEventArgs> callback =
                    delegate(object sender, ForceSelectObjectsReplyEventArgs e)
                        {
