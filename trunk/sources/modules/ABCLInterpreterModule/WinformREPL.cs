...
namespace ABCLScriptEngine
{
    ...
    public class LispEngine
    {
        ...
        WinformREPLTextBox.IPEWrapper.IPEStreamWrapper output;
        internal void SetStandardOutput(WinformREPLTextBox.IPEWrapper.IPEStreamWrapper iPEStreamWrapper)
        {
        ...
        WinformREPLTextBox.IronTextBoxControl ironTextBoxControl;

        internal void ExecuteToConsole(string command, WinformREPLTextBox.IronTextBoxControl ironTextBoxControl)
        {
