...
public sealed class MessageStop : Method {

    public const int TYPE = 1036;
    ...
    public MessageStop(String Destination, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageStop(context, this);
    }
