...
public sealed class SessionTimeout : Method {

    public const int TYPE = 518;
    ...
    public SessionTimeout(long Timeout, params Option[] options) {
        SetTimeout(Timeout);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionTimeout(context, this);
    }
