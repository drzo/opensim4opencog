...
public sealed class SessionDetach : Method {

    public const int TYPE = 515;
    ...
    public SessionDetach(byte[] Name, params Option[] options) {
        SetName(Name);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionDetach(context, this);
    }
    ...
    public SessionDetach ClearName() {
    ...
    public SessionDetach SetName(byte[] value) {
        _Name = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
