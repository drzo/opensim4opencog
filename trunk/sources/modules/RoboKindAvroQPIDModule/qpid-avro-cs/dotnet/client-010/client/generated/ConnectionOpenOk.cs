...
public sealed class ConnectionOpenOk : Method {

    public const int TYPE = 264;
    ...
    public ConnectionOpenOk(List<Object> KnownHosts, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ConnectionOpenOk(context, this);
    }
    ...
    public ConnectionOpenOk SetKnownHosts(List<Object> value) {
        _KnownHosts = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
