...
public sealed class ExchangeBind : Method {

    public const int TYPE = 1796;
    ...
    public ExchangeBind(String Queue, String Exchange, String BindingKey, Dictionary<String,Object> Arguments, params Option[] options) {
        SetQueue(Queue);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ExchangeBind(context, this);
    }
    ...
    public ExchangeBind SetArguments(Dictionary<String,Object> value) {
        _Arguments = value;
        packing_flags |=  2048;
        Dirty = true;
        return this;
