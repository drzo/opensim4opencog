...
public sealed class MessageRelease : Method {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageRelease(context, this);
    }
    ...
    public bool GetSetRedelivered() {
        return HasSetRedelivered();
    }

    public MessageRelease SetSetRedelivered(bool value) {
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_SetRedelivered", GetSetRedelivered());
