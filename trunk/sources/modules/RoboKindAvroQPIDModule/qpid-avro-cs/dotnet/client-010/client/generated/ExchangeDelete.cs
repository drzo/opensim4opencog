...
public sealed class ExchangeDelete : Method {
    ...
    public ExchangeDelete(String Exchange, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ExchangeDelete(context, this);
    }
    ...
    public ExchangeDelete SetIfUnused(bool value) {
