...
public sealed class MessageResume : Method {

    public const int TYPE = 1030;
    ...
    public MessageResume(String Destination, String ResumeId, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageResume(context, this);
    }
    ...
    public MessageResume ClearDestination() {
    ...
    public MessageResume SetDestination(String value) {
        _Destination = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
    ...
    public MessageResume ClearResumeId() {
    ...
    public MessageResume SetResumeId(String value) {
        _ResumeId = value;
        packing_flags |=  512;
        Dirty = true;
        return this;
