...
public sealed class MessageSetFlowMode : Method {

    public const int TYPE = 1033;
    ...
    public MessageSetFlowMode(String Destination, MessageFlowMode FlowMode, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageSetFlowMode(context, this);
    }
    ...
    public override void Write(IEncoder enc)
    {
        ...
        if ((packing_flags & 512) != 0)
            enc.WriteUint8((short)_FlowMode);
    ...
    public override void Read(IDecoder dec)
    {
        ...
        if ((packing_flags & 512) != 0)
            _FlowMode = MessageFlowModeGetter.Get(dec.ReadUint8());
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_FlowMode", GetFlowMode());
