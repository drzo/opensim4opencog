...
public sealed class SessionDetached : Method {

    public const int TYPE = 516;
    ...
    private byte[] _Name;
    private SessionDetachCode _Code;
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionDetached(context, this);
    }
