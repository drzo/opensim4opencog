...
public sealed class ConnectionTuneOk : Method {

    public const int TYPE = 262;
    ...
    public ConnectionTuneOk(int ChannelMax, int MaxFrameSize, int Heartbeat, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ConnectionTuneOk(context, this);
    }
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 1024) != 0)
            	result.Add("_Heartbeat", GetHeartbeat());
