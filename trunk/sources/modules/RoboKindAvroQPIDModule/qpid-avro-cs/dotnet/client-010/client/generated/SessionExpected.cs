...
public sealed class SessionExpected : Method {

    public const int TYPE = 520;
    ...
    public SessionExpected(RangeSet Commands, List<Object> Fragments, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionExpected(context, this);
    }
    ...
    public SessionExpected SetFragments(List<Object> value) {
        _Fragments = value;
        packing_flags |=  512;
        Dirty = true;
        return this;
