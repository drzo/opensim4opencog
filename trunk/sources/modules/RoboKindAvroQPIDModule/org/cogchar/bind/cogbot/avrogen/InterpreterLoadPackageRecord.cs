...
namespace org.cogchar.bind.cogbot.avrogen
{
	...
	public partial class InterpreterLoadPackageRecord : ISpecificRecord, InterpreterLoadPackage
	{
		private static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""InterpreterLoadPackageRecord"",""namespace"":""org.cogchar.bind.cogbot.avrogen"",""fields"":[{""name"":""sourceId"",""type"":""string""},{""name"":""destinationId"",""type"":""string""},{""name"":""timestampMillisecUTC"",""type"":""long""},{""name"":""requestId"",""type"":""string""},{""name"":""instanceLoadId"",""type"":""string""},{""name"":""packageName"",""type"":""string""}]}");
		...
		public virtual Schema Schema
		{
			get
			{
				return InterpreterLoadPackageRecord._SCHEMA;
			}
		}
