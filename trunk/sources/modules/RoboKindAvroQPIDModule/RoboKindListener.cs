...
namespace RoboKindAvroQPIDModule
{
    public class RoboKindListener
    {
        ...
        public RoboKindListener(string connectionUri)
        {
            ...
            channel.Bind(topicQueueName, ExchangeNameDefaults.TOPIC, RoboKindAvroQPIDModuleMain.COGBOT_CONTROL_ROUTING_KEY);
        ...
        public static void Main(String[] argv)
        {
            ...
            var rkl = new RoboKindListener(RoboKindAvroQPIDModuleMain.RK_QPID_URI);
