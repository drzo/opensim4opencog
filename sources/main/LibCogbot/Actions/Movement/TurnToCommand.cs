...
{
    internal class TurnToCommand : Cogbot.Actions.Command, BotPersonalCommand
    {
        ...
        {
            Description =
                "turn the avatar toward the specified position for a maximum of seconds. turnto [prim | [x y [z]]";
