...
{
    class ForwardCommand : Command, BotPersonalCommand
    {
        public ForwardCommand(BotClient client)
        {
            Name = "forward";
            Description = "Sends the move forward command to the server for a single packet or a given number of seconds.";
            Parameters =
