                    ...
                    if (this.TemplateNodeHasText)
                    {
                        if (TemplateNodeAttributes.Count > 0)
                        {
                            ...
                            {        
                                try
                                {
                                    Request subRequest0 = new Request(this.TemplateNodeInnerText, this.user, request.That, this.bot, false, request.RequestType | RequestKind.SraiTag);
                                    ...
                                    Result subResult0 = this.bot.sm.Chat(subRequest0, graphName);
                        ...
                        Result subResult = this.bot.sm.Chat(subRequest, graphName);
