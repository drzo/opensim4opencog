...
{
    abstract public partial class AIMLTagHandler_legacy
    {
            ...
            afterEachOrNull, bool saveResultsOnChildren)
        {
            ...
            else
            {
                if (!templateNode.HasChildNodes)
                {
                    ...
                    XmlNode starNode = Utils.AIMLTagHandler_legacy.getNode("<star/>", templateNode);
        ...
        protected Unifiable ProcessChildNode(XmlNode childNode, bool protectChildren, bool saveOnInnerXML)
        {
            try
            {
                ...
                else
                {
                    ...
                    AIMLTagHandler tagHandlerChild;
                    var value = Proc.TagHandling.processNode(childNode, query,
                                                 request, result, user,
