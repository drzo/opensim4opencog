...
namespace AltAIMLbot.Utils
{
    ...
    public abstract partial class AIMLTagHandlerU : TextTransformer, IAIMLTransaction, IXmlLineInfo, IDisposable, ConversationScopeHolder
    {
        ...
        public void SetParent(AIMLTagHandlerU handler)
        {
            if (handler == this)
            {
        ...
        public static bool CompleteEvaluatution(string vv, AIMLTagHandlerU childHandler, out Unifiable output)
        {
            string soutput;
        ...
        public static bool CompleteEvaluatution(String vv, AIMLTagHandlerU childHandler, out string output)
        {
...
//          recursiveStar.SetParent(this);
        ...
        public T GetAttribValue<T>(string attribName, T defaultIfEmpty) where T : IConvertible
        {
            return StaticXMLUtils.GetAttribValue(templateNode, attribName, defaultIfEmpty);
        }
        ...
        static public Unifiable ProcessAiml(string vv, out bool success, AIMLTagHandlerU tagHandler)
        {
            AIMLTagHandlerU parent = tagHandler;
            if (DLRConsole.IsTooDeep())
            {
                success = false;
        ...
        protected Unifiable ProcessChildNode(XmlNode childNode)
        {
            ...
            AIMLTagHandlerU tagHandlerChild = GetChildTagHandler(childNode);
        ...
        protected Unifiable ProcessChildNode(XmlNode childNode, bool protectChildren, bool saveOnInnerXML, out bool success, AIMLTagHandlerU tagHandlerChild)
        {
        ...
        static protected Unifiable ProcessTagHandlerNode(XmlNode childNode, bool protectChildren, bool saveOnInnerXML, out bool success, AIMLTagHandlerU tagHandlerChild)
        {            
            OutputDelegate writeToLogWarn = tagHandlerChild.writeToLogWarn;
            OutputDelegate writeToLog = tagHandlerChild.writeToLog;

            AIMLTagHandlerU parentHandler =  tagHandlerChild.Parent;
        ...
        Unifiable TryProcessingNodeAgain(AIMLTagHandlerU parent, XmlNode childNode, AIMLTagHandlerU tagHandlerChild, 
        ...
        private bool CheckReturnValue(Unifiable resultValue)
        {
            ...
            {
                ResetValues(true);
                var problem = "CompleteProcessU() == NULL " + LineNumberTextInfo();
                writeToLogWarn(problem);
                Proc.TraceTest(problem, () => ProcessChangeU());
                return false;
            }
        ...
        /*
        protected IEnumerable<AIMLTagHandlerU> CreateChildTagHandlers(IEnumerable<XmlNode> xmlNodes)
        {
        ...
        */
        ...
        public virtual Unifiable RecurseProcess()
        {
            ...
            AIMLTagHandlerU tagHandler = this;
            ...
            if (tagHandler.isRecursiveSubclass)
            {
                ...
                string v = tagHandler.ProcessChangeU();
        ...
        private Unifiable NonRecusiveResult()
        {
            ...
            string resultNodeInnerXML = templateNode.OuterXml;//.ProcessChangeU();
        ...
        protected virtual void AddSideEffect(string namedEffect, ThreadStart func)
        {
            ...
            AIMLTagHandlerU tagHandler = FirstTagHandlerOrOuterMost("template");
