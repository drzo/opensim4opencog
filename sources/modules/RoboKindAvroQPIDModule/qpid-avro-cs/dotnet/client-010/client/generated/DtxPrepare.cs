...
public sealed class DtxPrepare : Method {

    public const int TYPE = 1543;
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.DtxPrepare(context, this);
    }
    ...
    public DtxPrepare SetXid(Xid value) {
        _Xid = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
