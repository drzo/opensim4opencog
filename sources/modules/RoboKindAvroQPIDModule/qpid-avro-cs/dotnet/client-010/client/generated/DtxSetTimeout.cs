...
public sealed class DtxSetTimeout : Method {

    public const int TYPE = 1546;
    ...
    public DtxSetTimeout(Xid Xid, long Timeout, params Option[] options) {
        SetXid(Xid);
        SetTimeout(Timeout);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.DtxSetTimeout(context, this);
    }
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_Timeout", GetTimeout());
