...
public sealed class ConnectionSecure : Method {

    public const int TYPE = 259;
    ...
    public ConnectionSecure(byte[] Challenge, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ConnectionSecure(context, this);
    }
    ...
    public ConnectionSecure ClearChallenge() {
    ...
    public ConnectionSecure SetChallenge(byte[] value) {
        _Challenge = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 256) != 0)
            	result.Add("_Challenge", GetChallenge());
