...
public sealed class ExchangeQuery : Method {

    public const int TYPE = 1795;
    ...
    public ExchangeQuery(String Name, params Option[] options) {
        SetName(Name);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ExchangeQuery(context, this);
    }
    ...
    public ExchangeQuery ClearName() {
    ...
    public ExchangeQuery SetName(String value) {
        _Name = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
