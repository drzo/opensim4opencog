...
public sealed class DtxCommit : Method {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.DtxCommit(context, this);
    }
    ...
    public bool GetOnePhase() {
        return HasOnePhase();
    }

    public DtxCommit SetOnePhase(bool value) {
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_OnePhase", GetOnePhase());
