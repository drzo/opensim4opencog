...
public sealed class DtxGetTimeout : Method {

    public const int TYPE = 1542;
    ...
    public DtxGetTimeout(Xid Xid, params Option[] options) {
        SetXid(Xid);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.DtxGetTimeout(context, this);
    }
