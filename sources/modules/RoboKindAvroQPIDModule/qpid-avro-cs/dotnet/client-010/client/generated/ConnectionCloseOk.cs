...
public sealed class ConnectionCloseOk : Method {

    public const int TYPE = 268;
    ...
    public ConnectionCloseOk(params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ConnectionCloseOk(context, this);
    }
