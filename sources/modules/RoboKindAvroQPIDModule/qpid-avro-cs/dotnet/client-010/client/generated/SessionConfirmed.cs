...
public sealed class SessionConfirmed : Method {

    public const int TYPE = 521;
    ...
    public SessionConfirmed(RangeSet Commands, List<Object> Fragments, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionConfirmed(context, this);
    }
    ...
    public SessionConfirmed SetFragments(List<Object> value) {
        _Fragments = value;
        packing_flags |=  512;
        Dirty = true;
        return this;
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_Fragments", GetFragments());
