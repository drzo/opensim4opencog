...
public sealed class MessageFlush : Method {

    public const int TYPE = 1035;
    ...
    public MessageFlush(String Destination, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageFlush(context, this);
    }
    ...
    public MessageFlush ClearDestination() {
    ...
    public MessageFlush SetDestination(String value) {
        _Destination = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
