...
public sealed class ExecutionResult : Method {

    public const int TYPE = 770;
    ...
    public ExecutionResult(int CommandId, Struct Value, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ExecutionResult(context, this);
    }
