...
public sealed class MessageSubscribe : Method {

    public const int TYPE = 1031;
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.MessageSubscribe(context, this);
    }
    ...
    public MessageSubscribe SetExclusive(bool value) {
    ...
    public MessageSubscribe SetArguments(Dictionary<String,Object> value) {
        _Arguments = value;
        packing_flags |=  32768;
        Dirty = true;
        return this;
