...
public sealed class QueueQuery : Method {

    public const int TYPE = 2052;
    ...
    public QueueQuery(String Queue, params Option[] options) {
        SetQueue(Queue);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.QueueQuery(context, this);
    }
    ...
    public QueueQuery SetQueue(String value) {
        _Queue = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
