...
public sealed class SessionAttached : Method {

    public const int TYPE = 514;
    ...
    public SessionAttached(byte[] Name, params Option[] options) {
        SetName(Name);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionAttached(context, this);
    }
    ...
    public SessionAttached ClearName() {
    ...
    public SessionAttached SetName(byte[] value) {
        _Name = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
