...
public sealed class SessionCompleted : Method {

    public const int TYPE = 522;
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionCompleted(context, this);
    }
    ...
    public bool GetTimelyReply() {
        return HasTimelyReply();
    }

    public SessionCompleted SetTimelyReply(bool value) {
    ...
    public override Dictionary<String,Object> Fields
    {
		get
		{
        	...
        	if ((packing_flags & 512) != 0)
            	result.Add("_TimelyReply", GetTimelyReply());
