...
public sealed class ConnectionSecureOk : Method {

    public const int TYPE = 260;
    ...
    public ConnectionSecureOk(byte[] Response, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.ConnectionSecureOk(context, this);
    }
    ...
    public ConnectionSecureOk ClearResponse() {
    ...
    public ConnectionSecureOk SetResponse(byte[] value) {
        _Response = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
