...
public sealed class XaResult : Struct {

    public const int TYPE = 1537;
    ...
    public  void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.XaResult(context, this);
    }
