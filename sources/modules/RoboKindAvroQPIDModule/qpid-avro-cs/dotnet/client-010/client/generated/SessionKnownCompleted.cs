...
public sealed class SessionKnownCompleted : Method {

    public const int TYPE = 523;
    ...
    public SessionKnownCompleted(RangeSet Commands, params Option[] options) {
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionKnownCompleted(context, this);
    }
    ...
    public SessionKnownCompleted ClearCommands() {
    ...
    public SessionKnownCompleted SetCommands(RangeSet value) {
        _Commands = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
