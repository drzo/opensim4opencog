...
public sealed class DtxForget : Method {

    public const int TYPE = 1541;
    ...
    public DtxForget(Xid Xid, params Option[] options) {
        SetXid(Xid);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.DtxForget(context, this);
    }
    ...
    public DtxForget SetXid(Xid value) {
        _Xid = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
