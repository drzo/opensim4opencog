...
public sealed class SessionRequestTimeout : Method {

    public const int TYPE = 517;
    ...
    public SessionRequestTimeout(long Timeout, params Option[] options) {
        SetTimeout(Timeout);
    ...
    public override void Dispatch<C>(C context, MethodDelegate<C> mdelegate) {
        mdelegate.SessionRequestTimeout(context, this);
    }
