...
public sealed class DtxRollback : Method {

    public const int TYPE = 1545;
    ...
    public DtxRollback(Xid Xid, params Option[] options) {
        SetXid(Xid);
    ...
    public DtxRollback SetXid(Xid value) {
        _Xid = value;
        packing_flags |=  256;
        Dirty = true;
        return this;
