...
namespace org.cogchar.bind.cogbot.avrogen
{
	...
	public partial class InterpreterUnloadInstanceRecord : ISpecificRecord, InterpreterUnloadInstance
	{
		private static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""InterpreterUnloadInstanceRecord"",""namespace"":""org.cogchar.bind.cogbot.avrogen"",""fields"":[{""name"":""sourceId"",""type"":""string""},{""name"":""destinationId"",""type"":""string""},{""name"":""timestampMillisecUTC"",""type"":""long""},{""name"":""requestId"",""type"":""string""},{""name"":""instanceLoadId"",""type"":""string""}]}");
		...
		public virtual Schema Schema
		{
			get
			{
				return InterpreterUnloadInstanceRecord._SCHEMA;
			}
		}
