...
namespace RoboKindAvroQPIDModule
{
    public class RoboKindPublisher
    {
        ...
        public RoboKindPublisher(string connectionUri)
        {
            ...
            channel.Bind(responseQueueName, ExchangeNameDefaults.DIRECT, RoboKindAvroQPIDModuleMain.ROBOKIND_RESPONSE_ROUTING_KEY);
            ...
            publisher = channel.CreatePublisherBuilder()
                ...
                .WithRoutingKey(RoboKindAvroQPIDModuleMain.COGBOT_CONTROL_ROUTING_KEY)
                .Create();
        ...
        public static void Main(String[] argv)
        {
            ...
            RoboKindPublisher publisher = new RoboKindPublisher(RoboKindAvroQPIDModuleMain.RK_QPID_URI);

            // Publish the test messages.
            publisher.SendTextMessage("DoTest");
        }

        /// <summary>
        /// Sends the test messages and waits for all subscribers to reply with a report.
        /// </summary>
        public void SendBytesMessage(byte[] value)
        {
