#!/bin/bash
export MONO_PATH=.:/usr/lib/ikvm:/usr/lib64/mono/4.0
export SWI_HOME_DIR=/usr/local/lib/swipl-5.11.29
...
export LD_LIBRARY_PATH=.:$SWI_HOME_DIR/lib:/mnt/enki/development/opensim4opencog/bin:$SWI_HOME_DIR/lib/x86_64-linux:$JAVA_HOME/jre/lib/amd64/jli:$SWI_HOME_DIR/lib/x86_64-linux:$JAVA_HOME/jre/lib/amd64:$JAVA_HOME/jre/lib/amd64/server:/usr/lib64:/usr/local/lib64:/usr/lib:/usr/local/lib
