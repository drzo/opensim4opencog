...
namespace Iesi.Collections.Generic
{
    ...
    public sealed class SetWrapper<T> : ISet<T>
    {
        ...
        public ISet<T> IntersectWith(ISet<T> a)
        {
            return getSetCopy().Intersect(a);
        }
        ...
        public ISet<T> ExceptWith(ISet<T> a)
        {
            return getSetCopy().Minus(a);
        }
        ...
        public ISet<T> Clone()
        {
            return new SetWrapper<T>((ISet<T>)innerSet.Clone());
        }
        ...
        private Set<T> getSetCopy(ICollection c)
        {
            ...
            ((ISet<T>)retVal).AddAll((ICollection <T>)c);
            return retVal;
        }
