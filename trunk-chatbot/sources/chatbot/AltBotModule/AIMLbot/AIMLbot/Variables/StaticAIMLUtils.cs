    ...
    new RenderOptions()
    {
                        ...
                        case "topic":
                            {
                                ...
                                if (newTopic != null)
                                {
                                    if (IsNullOrEmpty(newTopic)) newTopic = Unifiable.Empty;
                                    needsUnwind = true;
                        ...
                        case "that":
                            {
                                ...
                                if (newThat != null)
                                {
                                    if (IsNullOrEmpty(newThat)) newThat = Unifiable.Empty;
                                    needsUnwind = true;
        ...
        */
        ...
        private static Unifiable ResolveVariableValue(string str, SubQuery query, ISettingsDictionary dict, out bool found)
        {
            ...
            {
                ISettingsDictionary dict2 = query.Request.TargetSettings;
                str = str.Substring(4);
            ...
            {
                ISettingsDictionary dict2 = query.Request.Responder.Predicates;
                str = str.Substring(4);
            ...
            {
                ISettingsDictionary dict2 = query.Request.Requester.Predicates;
                str = str.Substring(5);
                value = GetValue(query, dict2, str, out found);
                if (!IsNullOrEmpty(value))
                {
        ...
        public static bool IsPredMatch(Unifiable required, Unifiable actualValue, SubQuery subquery)
        {
            ...
            string requiredAsStringReplaceReplace = required.Replace(" ", "\\s")
        ...
        public static void PrintResult(Result result, OutputDelegate console, PrintOptions printOptions)
        {
            ...
            PrintTemplates(result.RawOutput, console, printOptions, TimeSpan.Zero);
