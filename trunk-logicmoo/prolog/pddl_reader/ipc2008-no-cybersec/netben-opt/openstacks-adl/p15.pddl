(define (problem os-netbenefit-p19_1)
...
(* (is-violated d-o16-p12) 1)
(* (is-violated d-o16-p14) 1)
(* (is-violated d-o17-p16) 1)
(* (is-violated d-o18-p15) 1)
