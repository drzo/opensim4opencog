(define (problem os-netbenefit-p21_1)
...
(* (is-violated d-o6-p17) 1)
(* (is-violated d-o7-p12) 1)
(* (is-violated d-o7-p15) 1)
...
(* (is-violated d-o13-p17) 1)
(* (is-violated d-o14-p12) 1)
(* (is-violated d-o15-p8) 1)
(* (is-violated d-o15-p9) 1)
(* (is-violated d-o16-p17) 1)
(* (is-violated d-o16-p18) 1)
(* (is-violated d-o16-p20) 1)
(* (is-violated d-o17-p10) 1)
(* (is-violated d-o18-p8) 1)
(* (is-violated d-o19-p4) 1)
(* (is-violated d-o19-p17) 1)
(* (is-violated d-o20-p18) 1)
(* (is-violated d-o21-p13) 1)
)))
)
