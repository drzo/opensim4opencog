(define (problem os-netbenefit-p23_1)
...
(* (is-violated d-o1-p17) 1)
(* (is-violated d-o2-p18) 1)
(* (is-violated d-o2-p23) 1)
(* (is-violated d-o3-p5) 1)
(* (is-violated d-o4-p6) 1)
(* (is-violated d-o4-p7) 1)
(* (is-violated d-o5-p14) 1)
(* (is-violated d-o5-p21) 1)
