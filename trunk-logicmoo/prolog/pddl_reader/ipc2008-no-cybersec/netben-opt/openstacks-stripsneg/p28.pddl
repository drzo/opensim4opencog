(define (problem os-netbenefit-p32_1)
...
(preference d-o3-p20 (delivered o3 p20))
...
(preference d-o23-p30 (delivered o23 p30))
(preference d-o23-p32 (delivered o23 p32))
...
(:metric maximize (- 512 (+
(total-cost)
(* (is-violated d-o1-p30) 1)
(* (is-violated d-o2-p20) 1)
(* (is-violated d-o2-p29) 1)
(* (is-violated d-o3-p4) 1)
(* (is-violated d-o3-p20) 1)
(* (is-violated d-o4-p9) 1)
(* (is-violated d-o4-p18) 1)
(* (is-violated d-o4-p23) 1)
(* (is-violated d-o5-p17) 1)
(* (is-violated d-o5-p19) 1)
(* (is-violated d-o5-p26) 1)
(* (is-violated d-o6-p9) 1)
(* (is-violated d-o6-p13) 1)
(* (is-violated d-o7-p11) 1)
(* (is-violated d-o7-p14) 1)
(* (is-violated d-o8-p19) 1)
(* (is-violated d-o9-p2) 1)
(* (is-violated d-o9-p12) 1)
(* (is-violated d-o10-p24) 1)
(* (is-violated d-o11-p25) 1)
(* (is-violated d-o11-p28) 1)
(* (is-violated d-o11-p30) 1)
(* (is-violated d-o12-p8) 1)
(* (is-violated d-o12-p17) 1)
(* (is-violated d-o13-p2) 1)
(* (is-violated d-o14-p15) 1)
(* (is-violated d-o14-p24) 1)
(* (is-violated d-o14-p29) 1)
(* (is-violated d-o15-p26) 1)
(* (is-violated d-o16-p16) 1)
(* (is-violated d-o17-p10) 1)
(* (is-violated d-o17-p13) 1)
(* (is-violated d-o17-p27) 1)
(* (is-violated d-o18-p29) 1)
(* (is-violated d-o19-p14) 1)
...
(* (is-violated d-o23-p30) 1)
(* (is-violated d-o23-p32) 1)
(* (is-violated d-o24-p3) 1)
(* (is-violated d-o25-p13) 1)
(* (is-violated d-o26-p22) 1)
(* (is-violated d-o27-p30) 1)
(* (is-violated d-o28-p28) 1)
(* (is-violated d-o29-p26) 1)
(* (is-violated d-o29-p31) 1)
(* (is-violated d-o29-p32) 1)
(* (is-violated d-o30-p16) 1)
(* (is-violated d-o31-p2) 1)
(* (is-violated d-o31-p9) 1)
(* (is-violated d-o32-p16) 1)
)))
)
