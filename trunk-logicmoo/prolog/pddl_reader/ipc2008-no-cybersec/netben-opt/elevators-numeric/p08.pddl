(define (problem elevators-netbenefit-p8_6_2)
...
(preference served4 (passenger-at p4 f3)) 
(preference served5 (passenger-at p5 f0)) 
))

(:metric maximize (- 404 (+ (total-cost)
(* (is-violated served0) 72)
(* (is-violated served1) 144)
(* (is-violated served2) 64)
(* (is-violated served3) 16)
(* (is-violated served4) 36)
(* (is-violated served5) 72)
)))
