(define (problem elevators-netbenefit-p8_6_1)
...
(preference served1 (passenger-at p1 f5)) 
(preference served2 (passenger-at p2 f2)) 
(preference served3 (passenger-at p3 f5)) 
(preference served4 (passenger-at p4 f5)) 
(preference served5 (passenger-at p5 f2)) 
))

(:metric maximize (- 230 (+ (total-cost)
(* (is-violated served0) 64)
(* (is-violated served1) 16)
(* (is-violated served2) 16)
(* (is-violated served3) 100)
(* (is-violated served4) 2)
(* (is-violated served5) 32)
)))
