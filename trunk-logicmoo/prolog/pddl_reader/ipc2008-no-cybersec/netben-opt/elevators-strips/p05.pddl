(define (problem elevators-netbenefit-p8_5_1)
...
(preference served4 (passenger-at p4 n3)) 
))

(:metric maximize (- 270 (+ (total-cost)
(* (is-violated served0) 4)
(* (is-violated served1) 16)
(* (is-violated served2) 196)
(* (is-violated served3) 4)
(* (is-violated served4) 50)
)))
