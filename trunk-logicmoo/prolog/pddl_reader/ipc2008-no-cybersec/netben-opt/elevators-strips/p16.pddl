(define (problem elevators-netbenefit-p12_5_4)
...
(preference served2 (passenger-at p2 n12)) 
(preference served3 (passenger-at p3 n1)) 
(preference served4 (passenger-at p4 n9)) 
))

(:metric maximize (- 1038 (+ (total-cost)
(* (is-violated served0) 4)
(* (is-violated served1) 196)
(* (is-violated served2) 484)
(* (is-violated served3) 98)
(* (is-violated served4) 256)
)))
