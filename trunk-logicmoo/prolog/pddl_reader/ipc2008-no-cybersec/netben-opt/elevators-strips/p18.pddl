(define (problem elevators-netbenefit-p12_6_4)
...
(:goal
(and
(preference served0 (passenger-at p0 n5)) 
(preference served1 (passenger-at p1 n3)) 
(preference served2 (passenger-at p2 n10)) 
(preference served3 (passenger-at p3 n2)) 
(preference served4 (passenger-at p4 n1)) 
(preference served5 (passenger-at p5 n6)) 
))

(:metric maximize (- 268 (+ (total-cost)
(* (is-violated served0) 16)
(* (is-violated served1) 98)
(* (is-violated served2) 36)
(* (is-violated served3) 18)
(* (is-violated served4) 98)
