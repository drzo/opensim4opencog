(define (problem elevators-netbenefit-p12_7_1)
...
(:goal
(and
(preference served0 (passenger-at p0 n4)) 
(preference served1 (passenger-at p1 n8)) 
(preference served2 (passenger-at p2 n8)) 
(preference served3 (passenger-at p3 n0)) 
(preference served4 (passenger-at p4 n10)) 
(preference served5 (passenger-at p5 n10)) 
(preference served6 (passenger-at p6 n7)) 
))

(:metric maximize (- 534 (+ (total-cost)
(* (is-violated served0) 98)
(* (is-violated served1) 18)
(* (is-violated served2) 32)
(* (is-violated served3) 72)
(* (is-violated served4) 8)
(* (is-violated served5) 256)
(* (is-violated served6) 50)
)))
